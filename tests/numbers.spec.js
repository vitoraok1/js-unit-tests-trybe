...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  ...
  it('Verifica se a função `numbers` retorna `false` ao receber o array [1, 2, `3`, 4, 5]', () => {
    expect(numbers([1, 2, '3', 4, 5])).toBe(false);
  });

  it('Verifica se a função `numbers` retorna `false` ao receber o array [1, `a`, 3]', () => {
    expect(numbers([1, 'a', 3])).toBe(false);
  });

  it('Verifica se a função `numbers` retorna `false` ao receber o array [` `]', () => {
